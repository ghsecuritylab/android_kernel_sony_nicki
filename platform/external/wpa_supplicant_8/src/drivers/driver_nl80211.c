...
skip_auth_type:
	...
	if (params->key_mgmt_suite == KEY_MGMT_802_1X ||
		params->key_mgmt_suite == KEY_MGMT_PSK	||            //CONN-FY-Fix_Dynamic_WEP_auth_problme-00
		params->key_mgmt_suite == KEY_MGMT_802_1X_NO_WPA) {   //CONN-FY-Fix_Dynamic_WEP_auth_problme-00

		int mgmt = WLAN_AKM_SUITE_PSK;

		switch (params->key_mgmt_suite) {
		case KEY_MGMT_802_1X:
		case KEY_MGMT_802_1X_NO_WPA:    //CONN-FY-Fix_Dynamic_WEP_auth_problme-00
